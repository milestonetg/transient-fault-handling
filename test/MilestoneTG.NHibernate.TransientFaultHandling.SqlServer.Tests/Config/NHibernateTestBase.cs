...
namespace NHibernate.SqlAzure.Tests.Config
{
    ...
    public abstract class NHibernateTestBase<T> where T: SqlClientDriver
    {
        ...
        private readonly ServiceController _serviceController = new ServiceController(ConfigurationManager.AppSettings["SqlServerServiceName"], Environment.MachineName);
